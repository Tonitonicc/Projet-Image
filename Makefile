OPENCVLIBS = -lopencv_core4110 -lopencv_imgproc4110 -lopencv_highgui4110 -lopencv_imgcodecs4110
...
CFLAGS =  -fPIE -Wall -ggdb -Werror -Wextra -pedantic -std=c++11 -Wno-unused-parameter -I./lib/ -I"C:/opencv/mingw-build/include"

OPENCV_LIB_DIR = C:/opencv/mingw-build/x64/mingw/lib
